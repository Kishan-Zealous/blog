<x-layout>
    ...
    <section class="max-w-4xl mx-auto flex  border mt-10 rounded-md">
        ...
        <form action="/admin/posts/{{ $post->id }}" method="POST" class="border rounded-xl  p-10 bg-gray-300 mx-10 my-10 w-full" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="font-bold text-center text-3xl">Edit Post</div>
            <div class="my-6">
